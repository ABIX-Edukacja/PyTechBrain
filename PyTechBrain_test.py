...
def read_analog():
  def ra():
    ...
    lab_2.config(text='Fotorezystor: '+str(int(1023*analog_2.read())))
    lab_3.config(text='Głośność: '+str(int(1023*analog_3.read())))
    lab_4.config(text='Temperatura: '+str(int(1023*analog_4.read())))
    lab_5.config(text='Potencjometr: '+str(int(1023*analog_5.read())))
    lab_5.after(100, ra)
  ra()
